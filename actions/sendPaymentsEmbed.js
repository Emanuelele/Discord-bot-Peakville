...
module.exports = {
    customId: "sendPaymentsEmbed",
    async execute(client) {

        const channel = client.channels.cache.get(process.env.PAYMENTS_CHANNEL_ID);
        ...
        try {
            ...
            const embed = new EmbedBuilder()
                .setColor(0xf9f4d8)
                .setTitle('Donazioni')
                .setDescription('Premi il pulsante sottostante per ricaricare i tuoi PeakPoints nel nostro shop.')
            ...
            const button = new ButtonBuilder()
                .setCustomId('createPaymentLink')
                .setLabel('Ricarica il tuo saldo')
